...
import static org.firstinspires.ftc.teamcode.common.drive.DriveConstants.MOTOR_VELO_PID;
import static org.firstinspires.ftc.teamcode.common.drive.DriveConstants.RUN_USING_ENCODER;
...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static double LATERAL_MULTIPLIER = 0.934;
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        follower = new HolonomicPIDVAFollower(TRANSLATIONAL_PID, TRANSLATIONAL_PID, HEADING_PID,
                new Pose2d(0.005, 0.005, Math.toRadians(0.005)), 1);

...
public class LeftCenterPreloadCommand extends SequentialCommandGroup {
    private static int TOLERANCE = 10;
    private static int stackHeight = 430;

    public LeftCenterPreloadCommand(Robot robot){
        super(
                new SequentialCommandGroup(
                        ...
                        new TurretPositionCommand(robot.turret,420,0,5000),
